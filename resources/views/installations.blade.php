            ...
            <div class="hero-content max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
                <div class="grid grid-cols-1 md:grid-cols-5 gap-10 lg:gap-16 items-center">
                    <div class="md:col-span-3 space-y-6 sm:space-y-8">
                        <h1 class="text-5xl font-display font-bold leading-tight">Sign and Awning Installations</h1>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                ...
                                <span class="text-3xl"><b>Professional Installation Services by Tri State Signs &amp;
                                        Awnings</b></span>
                            </li>
                        </ul>
                        <p>
                            At Tri State Signs & Awnings, we specialize in providing exceptional installation services
                            for a variety of signage and display needs. Serving the tri-state area, our experienced team
                            ensures that every project is completed with precision and care. With over 40 years of
                            industry experience, we understand the importance of a seamless installation process. Our
                            services include:
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base ">
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-green-700 mr-3 mt-0.5">home_repair_service</span>
                                <span><b>Sign Installation
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-green-700 mr-3 mt-0.5">home_repair_service</span>
                                <span><b>LED Display Installation</b></span>
                            </li>
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-green-700 mr-3 mt-0.5">home_repair_service</span>
                                <span><b>Awning Installation</b></span>
                            </li>
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-green-700 mr-3 mt-0.5">home_repair_service</span>
                                <span><b>Corporate Event Setup and Teardown</b></span>
                            </li>
                        ...
                        <p><button
                                class="text-xs bg-primary text-text-light font-bold py-2.5  rounded-md hover:bg-primary-light transform p-4"><a
                                    href="{{ url('/contact-us') }}">Contact us today</a></button> to get started with
                            your project.</p>
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-primary mr-3 mt-0.5">arrow_circle_right</span>
                                <span class="text-3xl"><b>Why You Need Professional Installation Services</b></span>
                            </li>
                        </ul>
                        <p>
                            Proper installation is crucial for the longevity and effectiveness of your signs and
                            displays. Here’s why choosing professional installation from Tri State Signs & Awnings is
                            essential:
                        </p>
                        <br>
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base ">
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-green-700 mr-3 mt-0.5">home_repair_service</span>
                                <span><b>Ensures longevity and durability of installations
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-green-700 mr-3 mt-0.5">home_repair_service</span>
                                <span><b> Enhances visibility and effectiveness of signage
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-green-700 mr-3 mt-0.5">home_repair_service</span>
                                <span><b> Complies with safety standards and regulations
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-green-700 mr-3 mt-0.5">home_repair_service</span>
                                <span><b> Streamlines the setup and teardown process</b></span>
                            </li>
                        ...
                        <p><button
                                class="text-xs bg-primary text-text-light font-bold py-2.5  rounded-md hover:bg-primary-light transform p-4"><a
                                    href="{{ url('/contact-us') }}">Reach out to us</a></button>to ensure your signage
                            and displays are installed correctly and efficiently.</p>
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-primary mr-3 mt-0.5">arrow_circle_right</span>
                                <span class="text-3xl"><b>Experience the Benefits of Our Installation Services
                                    </b></span>
                            </li>
                        </ul>
                        <p>
                            Choosing Tri State Signs & Awnings for your installation needs comes with numerous
                            advantages. Here’s what sets us apart:
                        </p>
                        <br>
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                ...
                                <span><b>30+ years of experience</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                                    home_repair_service</span>
                                <span><b> High-quality installation </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                                    home_repair_service
                                </span>
                                <span><b> OSHA 50 compliance </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                                    home_repair_service
                                </span>
                                <span><b>Complete setup and teardown for a seamless client experience</b></span>
                            </li>
                        ...
                        <p><button
                                class="text-xs bg-primary text-text-light font-bold py-2.5  rounded-md hover:bg-primary-light transform p-4"><a
                                    href="{{ url('/contact-us') }}">
                                    Call us today </a></button> to benefit from our professional installation services
                            and ensure your project is handled with expertise.
                    ...
                    <div class="text-text-light py-16 sm:py-20 lg:py-24 rounded-lg ">
                        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            ...
                            <div class="text-text-light py-4 sm:py-4 lg:py-4 rounded-lg bg-primary p-4">
                                ...
                                <h3 class="text-2xl font-bold text-text-light ">100% Satisfaction Guaranteed</h3>
                                <br>
        ...
        <section class="bg-green-900 py-2 sm:py-10 lg:py-10 text-text-light">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <p class="text-center  sm:mb-8">
                    If you’re ready to enhance your business with professionally installed signs and displays, <a
                        href="{{ url('/contact-us') }}"><u>get in touch with us</u></a>. Our team is here to provide
                    expert installation services tailored to your needs.
                </p>
