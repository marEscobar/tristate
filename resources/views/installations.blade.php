...
<head>
    ...
    <title>Installations | Tri State Signs & Awnings</title>
...
<body class="font-sans text-ink bg-white antialiased">
    ...
    <main>
                    ...
                    <div class="md:col-span-2 bg-white text-ink p-6 sm:p-8 rounded-xl shadow-2xl">
                        ...
                        <form class="space-y-4 sm:space-y-5">
                            <div>
                                ...
                                <input
                                    class="w-full bg-gray-100 border border-gray-300 rounded text-ink placeholder-gray-400 focus:ring-accent focus:border-accent transition-colors duration-300 text-sm sm:text-base px-3 py-2.5"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 ">
                    <div class="md:col-span-2">
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base ">
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-accent mr-3 mt-0.5">home_repair_service</span>
                    ...
                    <div class="text-text-light py-16 sm:py-20 lg:py-24 rounded-lg ">
                        <div class="max-w-[80rem] mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            ...
                            <br>
                            <div class="text-white py-4 sm:py-4 lg:py-4 rounded-xl bg-ink p-4">
        ...
        <section class="bg-ink text-white py-2 sm:py-10 lg:py-10 text-text-light" >
            <div class="max-w-[80rem] mx-auto px-4 sm:px-6 lg:px-8">
