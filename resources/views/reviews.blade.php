...
<head>
    ...
    <title>Reviews | Tri State Signs & Awnings | Customer Reviews West Babylon, NY</title>
...
<body class="font-sans text-ink bg-white antialiased">
    ...
    <main>
        <section class="bg-accent py-2 sm:py-6 lg:py-6 text-white pt-20">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center space-x-2">
                    <div class="flex text-accent">
                        <span class="material-symbols-outlined text-xs sm:text-base"
                            style="font-size: 3rem;">star</span>
                        <span class="material-symbols-outlined text-xs sm:text-base"
                            style="font-size: 3rem;">star</span>
                        <span class="material-symbols-outlined text-xs sm:text-base"
                            style="font-size: 3rem;">star</span>
                    ...
                    <span class="font-medium text-ink">5.0</span>
                    <a class="underline hover:text-accent transition-colors duration-300"
                        href="{{ url('/reviews') }}"> Overall Rating</a>

                    <button id="openReviewModal"
                        class="inline-block btn-accent text-white font-bold px-5 sm:px-6 py-2.5 rounded-xl hover:shadow-lg transition-all duration-300 text-xs sm:text-sm">Write
                        a Review</button>
                </div>
                <br>
