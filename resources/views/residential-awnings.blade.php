...
<head>
    ...
    <title>Residential Awnings | Tri State Signs & Awnings | Custom Awnings West Babylon, NY</title>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 ">
                    <div class="md:col-span-2">
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base ">
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-accent mr-3 mt-0.5">home</span>
