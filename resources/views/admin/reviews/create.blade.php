...
<head>
    ...
    <title>Create Review | Tri State Signs & Awnings</title>
        ...
        <header class="bg-ink text-white shadow-lg">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div class="flex items-center justify-between">
                    <h1 class="text-2xl font-display font-bold">Create New Review</h1>
                ...
                <form action="{{ route('reviews.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        <label class="flex items-center">
                            ...
                            <span class="ml-2 text-sm font-medium text-gray-700">Approve immediately</span>
                        </label>
                    </div>
