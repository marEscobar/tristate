        ...
        <section class="hero-bg text-text-light">
            <div class="hero-content max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
                <div class="text-center">
                    ...
                    <p class="text-sm sm:text-base mb-4 text-secondary">December 20, 2024</p>
        ...
        <section class="bg-white py-16 sm:py-20 lg:py-24">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <article class="prose prose-lg max-w-none">
                    <div class="mb-8">
                        <img src="{{ asset('img/exterior/ext6.JPG') }}" alt="Sign Maintenance" class="w-full h-auto rounded-lg shadow-lg">
                    </div>
