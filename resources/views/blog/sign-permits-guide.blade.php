        ...
        <section class="hero-bg text-text-light">
            <div class="hero-content max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
                <div class="text-center">
                    ...
                    <p class="text-sm sm:text-base mb-4 text-secondary">December 28, 2024</p>
        ...
        <section class="bg-white py-16 sm:py-20 lg:py-24">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <article class="prose prose-lg max-w-none">
                    <div class="mb-8">
                        <img src="{{ asset('img/exterior/ext4.JPG') }}" alt="Sign Permits" class="w-full h-auto rounded-lg shadow-lg">
                    </div>
                    ...
                    <p class="text-base text-text-muted-light dark:text-text-muted-dark mb-8 leading-relaxed">
                        Ready to install a new sign but need help with permits? <a href="{{ url('/contact-us') }}" class="text-primary hover:underline font-semibold">Contact Tri State Signs & Awnings</a> today. Our experienced team handles all permit requirements, ensuring your sign installation is compliant and on schedule.
                    </p>
                </article>
