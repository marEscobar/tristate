    ...
    <main>
        ...
        <section class="bg-white py-16 sm:py-10 lg:py-14 text-text-primary">
            <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h3
                    class="text-xl sm:text-xl lg:text-xl font-display font-bold text-text-primary mb-8 sm:mb-6 text-center">
                ...
                <br>
                <button
                    class="bg-green-700 p-4 text-text-light font-bold py-2.5 sm:py-3 rounded-md hover:bg-primary-light transform hover:-translate-y-0.5 transition-all duration-300 shadow-md text-sm sm:text-base">5%
                    OFF <br>
