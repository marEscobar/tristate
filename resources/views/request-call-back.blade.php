...
<head>
    ...
    <title>Request Call Back | Tri State Signs & Awnings | Custom Signs West Babylon, NY</title>
...
<body class="font-sans text-ink bg-white antialiased">
    ...
    <main>
        <section class="bg-accent py-2 sm:py-6 lg:py-6 text-white">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section class="bg-white py-16 sm:py-10 lg:py-14 text-ink">
            <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h3
                    class="text-xl sm:text-xl lg:text-xl font-display font-bold text-ink mb-8 sm:mb-6 text-center">
                    Now Offering Virtual Conferences!
                </h3>
                <p class="max-w-4xl mx-auto text-center">
                    Fill out this short form, and a Tri State Signs & Awnings representative will contact you by the
                    next business day.
                </p>
                <br>
                <button
                    class="bg-accent p-4 text-white font-bold py-2.5 sm:py-3 rounded-xl hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 shadow-md text-sm sm:text-base">5%
                    OFF <br>

                    Choose a service, and get 5% off just <br> for making the virtual call!</button>
                ...
                <div class="md:col-span-2 bg-white text-ink p-6 sm:p-8 rounded-xl shadow-2xl">
                    ...
                    <form class="space-y-4 sm:space-y-5">
                        ...
                        <div class="text-left">
                            ...
                            <br>
                            <ul>
                                <li> - For all virtual call backs, we will contact you to schedule a day and time.</li>
                                <li> - For Zoom, any smartphone or computer can join a Zoom call, and you do NOT need to have a Zoom account to join your virtual meeting. If you are going to use your phone or tablet, you will need to download the Zoom Cloud Meetings app to join the meeting.</li>
                                <li> - For Google Meet, please be sure the email address provided above is associated with your Google account.</li>
                            </ul>
                        </div>
                        <div>
