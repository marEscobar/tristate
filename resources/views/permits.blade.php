            ...
            <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 ">
                    <div class="md:col-span-2">
                        ...
                        <h3 class="text-2xl font-bold text-text-primary"><b>Work With the Professionals</b></h3>
                        <p>
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base ">
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">approval</span>
                    ...
                    <div class="text-text-light py-16 sm:py-20 lg:py-24 rounded-lg ">
                        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            ...
                            <div class="text-text-light py-4 sm:py-4 lg:py-4 rounded-lg bg-primary p-4">
                                ...
                                <h3 class="text-2xl font-bold text-text-light ">Same-Day Appointments Are Available for
