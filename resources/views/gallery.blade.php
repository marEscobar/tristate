...
<head>
    ...
    <title>Gallery | Tri State Signs & Awnings</title>
        ...
        <section class="bg-white py-16 sm:py-10 lg:py-14 text-ink">
            <div class="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <p class="max-w-4xl mx-auto text-center">
                    At Tri State Signs & Awnings, we pride ourselves on our unwavering commitment to 100% customer
                    satisfaction in every project we undertake. Specializing in a diverse range of products including
                    exterior and interior signs, commercial and residential awnings, cutting-edge LED displays, sign
                    permit expediting, and seamless installation services, we make the entire process as smooth as
                    possible.
                    <br>
                    <br>
                    View our photos below to see what we can offer you. Call us today to get started.
                </p>
                <br><br>
