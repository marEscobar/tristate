...
<head>
    ...
    <title>Exterior Signs | Tri State Signs & Awnings</title>
...
<body class="font-sans text-ink bg-white antialiased">
                ...
                <div class="text-center max-w-4xl mx-auto space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6">
                        <a href="tel:7187050333"
                            class="inline-flex items-center gap-2 px-8 py-4 bg-white text-accent font-bold rounded-xl hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-lg text-lg">
                            <span class="material-symbols-outlined">phone</span>
                            (718) 705-0333
                        </a>
                        <a href="{{ url('/request-call-back') }}"
                            class="inline-flex items-center gap-2 px-8 py-4 btn-accent text-white font-bold rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-300 shadow-lg text-lg">
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                ...
                                <span class="text-3xl"><b>Exterior Custom Signs in Bay Shore, NY and Beyond</b></span>
                            </li>
                        </ul>
                        <p>
                            If you’re thinking about elevating the look and feel of your business, curating your signage
                            is a great place to start. At Tri State Signs & Awnings, we offer a wide range of signage
                            for all business. When you need exterior custom signs in Deer Park, NY and the surrounding
                            areas, we have everything you need! Our store is the one-stop shop for taking your business
                            to the next level.
                            <br>
                            <br>

                            If you’re searching for the exterior custom signs Bay Shore, NY businesses have loved for
                            years, you’re in the right place. Whatever your vision is, our team is here to bring it to
                            life. Your business should reflect your personality and the unique space that you have made
                            your own. Your signage doesn’t have to be out-dated or break the bank. We offer plenty of
                            options for all budgets. Reach out to us today to get started.
                        </p>
                        <br>
                        <p><b> We Offer:</b></p>
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base">
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">nest_tag</span>
                                <span><b>Channel letters</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">nest_tag</span>
                                <span><b>Box signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">nest_tag</span>
                                <span><b>Multi-tenant signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">nest_tag</span>
                                <span><b>Pylon signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">nest_tag</span>
                            ...
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">nest_tag</span>
                                <span><b>Banners</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">nest_tag</span>
                                <span><b>Gold leaf carved signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">nest_tag</span>
                                <span><b>Aluminum signs </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">nest_tag</span>
                                <span><b>Blade signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">nest_tag</span>
                                <span><b>Directional signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">nest_tag</span>
                                <span><b>Monument signs</b></span>
                            </li>
                        </ul>
                        <br>
                        <p><button
                                class="text-xs btn-accent text-white font-bold py-2.5  rounded-xl hover:shadow-lg transform p-4"><a
                                    href="{{ url('/contact-us') }}">Contact us today</a></button> to discover how we
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-primary mr-3 mt-0.5">arrow_circle_right</span>
                                <span class="text-3xl"><b>Why You Need Our Services </b></span>
                            </li>
                        </ul>
                        <p>
                            Effective exterior signs are essential for any business looking to elevate its presence and
                            brand visibility. <br>
                            Here's why:
                        </p>
                        <br>
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base">
                            <li class="flex items-start">
                                ...
                                <span><b>Attract customers with eye-catching designs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                                    nest_tag
                                ...
                                <span><b>
                                        Enhance brand recognition and awareness</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                                    nest_tag
                                ...
                                <span><b>
                                        Guide visitors and improve navigation
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                            ...
                            <li class="flex items-start">
                                ...
                                <span><b>
                                        Stand out in a competitive market</b></span>
                            </li>
                        </ul>
                        ...
                        <p><button
                                class="text-xs btn-accent text-white font-bold py-2.5  rounded-xl hover:shadow-lg transform p-4"><a
                                    href="{{ url('/contact-us') }}">Reach out to us </a></button> to explore your
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-primary mr-3 mt-0.5">arrow_circle_right</span>
                                <span class="text-3xl"><b>Benefits of Choosing Our Signage Solutions </b></span>
                            </li>
                        </ul>
                        <p>
                            Choosing Tri State Signs & Awnings for your exterior signage comes with a multitude of
                            benefits:
                        </p>
                        <br>
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base">
                            ...
                            <li class="flex items-start">
                                ...
                                <span><b>
                                        Full customization to suit your brand</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                                    nest_tag
                                ...
                                <span><b>
                                        Innovative technology for advanced designs
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                            ...
                            <li class="flex items-start">
                                ...
                                <span><b>
                                        Site survey and assessment for precise placement</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                                    nest_tag
                        ...
                        <p><button
                                class="text-xs btn-accent text-white font-bold py-2.5  rounded-xl hover:shadow-lg transform p-4"><a
                                    href="{{ url('/contact-us') }}">
                                    Get in touch with us </a></button> today to transform your business with our
                            top-tier exterior signage solutions.
                        </p>
                    ...
                    <div class="text-text-light py-16 sm:py-20 lg:py-24 rounded-lg ">
                        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            ...
                            <div class="text-text-light py-4 sm:py-4 lg:py-4 rounded-lg bg-primary p-4">
                                <span class="material-symbols-outlined text-3xl text-text-light p-2" style="font-size: 4rem;" >
                                    local_hospital
                                    </span>
                                <h3 class="text-2xl font-bold text-text-light ">Five-Year New Sign Warranty</h3>
                                <br>
                            ...
                            <div class="text-text-light py-4 sm:py-4 lg:py-4 rounded-lg bg-gray-100 p-4 text-left">
                                ...
                                <br>
                                <h3 class="text-md font-bold text-text-dark "> <a href="{{ url('/exterior-signs') }}"><u>Exterior Signs </u></a></h3>
                                <br>
                                <h3 class="text-md font-bold text-text-dark "> <a href="{{ url('/interior-signs') }}">Interior Signs </a></h3>
                                <br>
                                <h3 class="text-md font-bold text-text-dark "> <a href="{{ url('/permits') }}">Sign Permit Expediting</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="bg-green-900 py-4 sm:py-10 lg:py-10 text-text-light">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <p class="text-center  sm:mb-12">
                    Ready to enhance your business visibility? <a href="{{ url('/contact-us') }}"><u>Speak to us today</u></a>. <br> Our team is here to provide expert guidance and ensure your signage needs are met with excellence.
                </p>
    ...
    <div id="imageModal" class="fixed inset-0 z-50 hidden overflow-y-auto" aria-labelledby="imageModalLabel" aria-hidden="true">
        <!-- Backdrop -->
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            <div class="relative max-w-7xl w-full transform transition-all">
                <!-- Close Button -->
                <button id="closeImageModal" type="button" class="absolute top-4 right-4 z-10 text-white hover:text-gray-300 transition-colors bg-black/50 rounded-full p-2">
                    <span class="material-symbols-outlined text-3xl">close</span>
                </button>

                <!-- Image Container -->
                <div class="relative w-full">
                    <img id="modalImage" src="" alt="" class="w-full h-auto max-h-[90vh] object-contain mx-auto rounded-lg shadow-2xl">
