                        ...
                        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            <div class="text-text-light py-4 sm:py-4 lg:py-4 rounded-lg bg-green-700 p-4 text-white">
                                ...
                                <button id="openReviewModal"
                                    class="inline-block bg-white text-primary text-black hover:text-text-light font-bold px-5 sm:px-6 py-2.5 rounded-md hover:bg-primary-light transition-colors duration-300 text-xs sm:text-sm">Write
                                    a Review</button>
