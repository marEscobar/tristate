...
<head>
    ...
    <title>Interior Signs | Tri State Signs & Awnings | Custom Signs West Babylon, NY</title>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 ">
                    <div class="md:col-span-2">
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base ">
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-accent mr-3 mt-0.5">open_with</span>
                    ...
                    <div class="text-white py-16 sm:py-20 lg:py-24 rounded-lg ">
                        <div class="max-w-[80rem] mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            ...
                            <div class="text-white py-4 sm:py-4 lg:py-4 rounded-xl bg-ink text-white p-4">
                                ...
                                <h3 class="text-2xl font-bold text-white ">Your Satisfaction Is 100% Guaranteed</h3>
                                <br>
                            ...
                            <div class="text-white py-4 sm:py-4 lg:py-4 rounded-xl bg-gray-100 p-4 text-left">
                                ...
                                <br>
                                <h3 class="text-md font-bold text-ink "> <a href="{{ url('/permits') }}">Sign
