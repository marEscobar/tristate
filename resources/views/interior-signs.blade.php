...
<head>
    ...
    <style>
        ...
        .hero-bg::before {
            ...
            position: absolute;
            inset: 0;
            background-color: rgba(29, 16, 1, 0.75);
            z-index: 1;
        }
            ...
            <div class="hero-content max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
                <div class="grid grid-cols-1 md:grid-cols-5 gap-10 lg:gap-16 items-center">
                    <div class="md:col-span-3 space-y-6 sm:space-y-8">
                        <h1 class="text-5xl font-display font-bold leading-tight">Interior Custom Signs in Farmingdale,
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 ">
                    <div class="md:col-span-2">
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                ...
                                <span class="text-3xl"><b>Interior Signs by Tri State Signs & Awnings</b></span>
                            </li>
                        </ul>
                        <p>
                            Discover the high-quality interior signs from Tri State Signs & Awnings. Serving the
                            tri-state area, we specialize in creating custom signage solutions that elevate your
                            business environment. Whether you need directional signs, wall graphics, or digital
                            displays, our expert team ensures your needs are met with precision and professionalism.
                            <br> Our services include:
                        </p>
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base ">
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>ADA compliance signs
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Wayfinding signs
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b> Lobby and reception signs
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Wall graphics and murals</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Digital signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Dimensional signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Menu boards</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Informational signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Banner signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Window graphics</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Suspended/projecting signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Acrylic and glass signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Directional and room identification signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Frame signs (snap frames or poster frames)</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Floor graphic signs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Posters and art prints</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Name plate and office signs</b></span>
                            </li>
                        </ul>
                        <br>
                        <p><button
                                class="text-xs bg-primary text-text-light font-bold py-2.5  rounded-md hover:bg-primary-light transform p-4"><a
                                    href="{{ url('/contact-us') }}">Contact us today</a></button> to discuss how we
                            can meet your signage needs.</p>
                        <br>
                        <p>
                            Questions about our selection of interior custom signs in Farmingdale, NY and the
                            surrounding areas? We’re happy to answer any inquiries that you may have. Don’t hesitate to
                            begin your journey to getting the sign of your dreams. Instead, explore our website. We
                            proudly offer a plethora of custom signs in Hauppauge, NY and the surround areas. It’s never
                            been easier to improve the aesthetic of your home. The little things truly do make a
                            difference. From acrylic signs to art prints, there are a million ways to spark joy in your
                            home or elevate your business. Our signage is built to last. Learn more about our interior
                            signage by contacting us today!
                        </p>
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base">
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-primary mr-3 mt-0.5">arrow_circle_right</span>
                                <span class="text-3xl"><b>Why You Need Interior Signs</b></span>
                            </li>
                        </ul>
                        <p>
                            Interior signs play a vital role in enhancing the functionality and aesthetics of your
                            business space. They help guide visitors, inform customers, and reinforce your brand
                            identity. Here’s why investing in interior signs is beneficial:
                        </p>
                        <br>
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base ">
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Improves customer experience
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b> Ensures ADA compliance
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b> Enhances brand visibility
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b> Provides clear directions
                                    </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Communicates important information</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">open_with</span>
                                <span><b>Creates a cohesive environment</b></span>
                            </li>
                        ...
                        <p><button
                                class="text-xs bg-primary text-text-light font-bold py-2.5  rounded-md hover:bg-primary-light transform p-4"><a
                                    href="{{ url('/contact-us') }}">Reach out to us</a></button> to start improving
                            your business environment with our interior signage solutions.</p>
                        <br>
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-primary mr-3 mt-0.5">arrow_circle_right</span>
                                <span class="text-3xl"><b>Benefits of Choosing Tri State Signs &amp; Awnings
                                    </b></span>
                            </li>
                        </ul>
                        <p>
                            When you partner with Tri State Signs & Awnings, you’re choosing a commitment to quality and
                            customer satisfaction. Our services offer numerous benefits that set us apart:
                        </p>
                        <br>
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base">
                            <li class="flex items-start">
                                ...
                                <span><b>Quality and durability guaranteed</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                                    open_with
                            ...
                            <li class="flex items-start">
                                ...
                                <span><b>
                                        High-quality materials and craftsmanship</b></span>
                            </li>
                        </ul>
                        ...
                        <p><button
                                class="text-xs bg-primary text-text-light font-bold py-2.5  rounded-md hover:bg-primary-light transform p-4"><a
                                    href="{{ url('/contact-us') }}">
                                    Speak with us today </a></button> to experience the advantages of our top-tier
                    ...
                    <div class="text-text-light py-16 sm:py-20 lg:py-24 rounded-lg ">
                        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            <div class="text-text-light py-4 sm:py-4 lg:py-4 rounded-lg bg-green-700 p-4">
                                <h3 class="text-3xl font-bold text-text-light ">Reviews</h3>
                                <br>
                                ...
                                <button id="openReviewModal"
                                    class="inline-block bg-white text-primary text-text-primary hover:text-text-light font-bold px-5 sm:px-6 py-2.5 rounded-md hover:bg-primary-light transition-colors duration-300 text-xs sm:text-sm">Write
                                    a Review</button>

                            </div>
                            <br>
                            <div class="text-text-light py-4 sm:py-4 lg:py-4 rounded-lg bg-primary p-4">
                                <span class="material-symbols-outlined text-3xl text-text-light p-2"
                                    style="font-size: 4rem;">
                                    filter_frames
                                </span>
                                <h3 class="text-2xl font-bold text-text-light ">Your Satisfaction Is 100% Guaranteed</h3>
                                <br>
                                <h3 class="text-xl text-text-light ">Call Us for a Free Estimate</h3>
                                <br>
                            ...
                            <div class="text-text-light py-4 sm:py-4 lg:py-4 rounded-lg bg-gray-100 p-4 text-left">
                                ...
                                <br>
                                <h3 class="text-md font-bold text-text-dark "> <a
                                        href="{{ url('/interior-signs') }}"><u>Interior Signs </u></a></h3>
                                <br>
                                <h3 class="text-md font-bold text-text-dark "> <a href="{{ url('/permits') }}">Sign
                                        Permit Expediting</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="bg-green-900 py-4 sm:py-10 lg:py-10 text-text-light">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <p class="text-center  sm:mb-12">
                    Ready to enhance your business space with custom interior signs? <a href="{{ url('/contact-us') }}"><u>Get in touch with us</u></a>.
                    <br>Our team is here to meet your signage needs with professionalism and expertise.
                </p>
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 lg:gap-12 items-center">
                    <div class="md:col-span-1">
                        <img src="{{ asset('img/interior/int1.JPG') }}" alt="Contact"
                            class="w-full object-cover cursor-pointer hover:opacity-90 transition-opacity"
                            style="height: 14rem"
                            onclick="openImageModal('{{ asset('img/interior/int1.JPG') }}', 'Contact')">
                    </div>
                    <div class="md:col-span-1">
                        <img src="{{ asset('img/interior/int2.JPG') }}" alt="Contact"
                            class="w-full object-cover cursor-pointer hover:opacity-90 transition-opacity"
                            style="height: 14rem"
                            onclick="openImageModal('{{ asset('img/interior/int2.JPG') }}', 'Contact')">
                    </div>
                    <div class="md:col-span-1">
                        <img src="{{ asset('img/interior/int3.jpg') }}" alt="Contact"
                            class="w-full object-cover cursor-pointer hover:opacity-90 transition-opacity"
                            style="height: 14rem"
                            onclick="openImageModal('{{ asset('img/interior/int3.jpg') }}', 'Contact')">
                    </div>
                    <div class="md:col-span-1">
                        <img src="{{ asset('img/interior/int4.JPG') }}" alt="Contact"
                            class="w-full object-cover cursor-pointer hover:opacity-90 transition-opacity"
                            style="height: 14rem"
                            onclick="openImageModal('{{ asset('img/interior/int4.JPG') }}', 'Contact')">
                    </div>
