...
<head>
    ...
    <title>LED Displays | Tri State Signs & Awnings | Custom Signs West Babylon, NY</title>
...
<body class="font-sans text-ink bg-white antialiased">
    ...
    <main>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 ">
                    <div class="md:col-span-2">
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base ">
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-accent mr-3 mt-0.5">tv_displays</span>
                    ...
                    <div class="text-white py-16 sm:py-20 lg:py-24 rounded-lg ">
                        <div class="max-w-[80rem] mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            ...
                            <div class="text-white py-4 sm:py-4 lg:py-4 rounded-xl bg-accent p-4">
                                ...
                                <h3 class="text-2xl font-bold text-white ">One-Year Electrical Warranty on LED Lighting Service</h3>
                                <br>
                                <h3 class="text-xl text-white ">Call Us for a Free Quote</h3>
                                <br>
        ...
        <section class="bg-ink py-2 sm:py-10 lg:py-10 text-white">
            <div class="max-w-[80rem] mx-auto px-4 sm:px-6 lg:px-8">
