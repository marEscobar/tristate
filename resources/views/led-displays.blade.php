...
<body class="font-sans bg-background-light dark:bg-background-dark text-text-dark dark:text-text-light antialiased">
    ...
    <main>
            ...
            <div class="hero-content max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 lg:py-32">
                <div class="grid grid-cols-1 md:grid-cols-5 gap-10 lg:gap-16 items-center">
                    <div class="md:col-span-3 space-y-6 sm:space-y-8">
                        <h1 class="text-5xl font-display font-bold leading-tight">LED Signs and Displays</h1>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                ...
                                <span class="text-3xl"><b>LED Displays by Tri State Signs &amp; Awnings</b></span>
                            </li>
                        </ul>
                        <p>
                            At Tri State Signs & Awnings, we specialize in delivering superior LED displays tailored to
                            meet your specific needs. Serving the tri-state area, our expertise in custom LED display
                            fabrication and maintenance ensures your business stands out. Whether you're looking to
                            update your storefront or need a reliable service partner, our innovative technology and
                            commitment to quality guarantee satisfaction. Our offerings include:

                        </p>
                        <br>
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base ">
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">tv_displays</span>
                                <span><b>Custom LED display fabrication</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">tv_displays</span>
                                <span><b>Service and maintenance for LED displays</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">tv_displays</span>
                                <span><b>Innovative LED display technology</b></span>
                            </li>
                        ...
                        <p><button
                                class="text-xs bg-primary text-text-light font-bold py-2.5  rounded-md hover:bg-primary-light transform p-4"><a
                                    href="{{ url('/contact-us') }}">Contact us today</a></button> to discuss your LED
                            display needs.</p>
                        <br>
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-primary mr-3 mt-0.5">arrow_circle_right</span>
                                <span class="text-3xl"><b>Why You Need LED Displays</b></span>
                            </li>
                        </ul>
                        <p>
                            LED displays are essential for businesses aiming to enhance visibility and engage customers
                            effectively. They offer a dynamic way to showcase your message and brand. Our services cater
                            to various needs:
                        </p>
                        <br>
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base ">
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">tv_displays</span>
                                <span><b>Enhance storefront visibility</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">tv_displays</span>
                                <span><b> Engage customers with dynamic displays</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">tv_displays</span>
                                <span><b> Innovative technology for modern needs</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">tv_displays</span>
                                <span><b> Reliable service and maintenance</b></span>
                            </li>
                        ...
                        <p><button
                                class="text-xs bg-primary text-text-light font-bold py-2.5  rounded-md hover:bg-primary-light transform p-4"><a
                                    href="{{ url('/contact-us') }}">Get in touch </a></button>with Tri State Signs &
                            Awnings for your LED display solutions.</p>
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                <span
                                    class="material-symbols-outlined text-primary mr-3 mt-0.5">arrow_circle_right</span>
                                <span class="text-3xl"><b>Benefits of Choosing Us </b></span>
                            </li>
                        </ul>
                        <p>Our LED displays are designed to meet the highest standards of quality and durability. We
                            offer full customization to ensure your display aligns perfectly with your brand. Here’s why
                        ...
                        <ul class="space-y-3 sm:space-y-4 text-sm sm:text-base lg:text-lg">
                            <li class="flex items-start">
                                ...
                                <span><b>Guaranteed quality and durability</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                                    tv_displays</span>
                                <span><b> Full customization of LED displays</b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                                    tv_displays
                                </span>
                                <span><b> Use of innovative technology </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                                    tv_displays
                                </span>
                                <span><b> Compliance with safety standards </b></span>
                            </li>
                            <li class="flex items-start">
                                <span class="material-symbols-outlined text-green-700 mr-3 mt-0.5">
                                    tv_displays
                                </span>
                                <span><b> High-quality materials and craftsmanship </b></span>
                            </li>
                        ...
                        <p><button
                                class="text-xs bg-primary text-text-light font-bold py-2.5  rounded-md hover:bg-primary-light transform p-4"><a
                                    href="{{ url('/contact-us') }}">
                                    Speak with us </a></button> at Tri State Signs & Awnings to experience the benefits of our superior LED displays.
                        </p>
                    ...
                    <div class="text-text-light py-16 sm:py-20 lg:py-24 rounded-lg ">
                        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                            ...
                            <div class="text-text-light py-4 sm:py-4 lg:py-4 rounded-lg bg-primary p-4">
                                ...
                                <h3 class="text-2xl font-bold text-text-light ">One-Year Electrical Warranty on LED Lighting Service</h3>
                                <br>
                                <h3 class="text-xl text-text-light ">Call Us for a Free Quote</h3>
                                <br>
        ...
        <section class="bg-green-900 py-2 sm:py-10 lg:py-10 text-text-light">
            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="text-2xl sm:text-3xl lg:text-4xl font-display font-bold text-center mb-8 sm:mb-6">
                    Contact Us
                </h2>
                <p class="text-center  sm:mb-8">
                    Ready to elevate your business with a custom LED display? <a
                        href="{{ url('/contact-us') }}"><u>Reach out to us</u></a>. <br>  today. We’re here to meet your needs and ensure your satisfaction.
